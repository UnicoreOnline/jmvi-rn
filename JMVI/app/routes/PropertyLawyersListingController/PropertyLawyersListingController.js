...
class PropertyLawyersListingController extends Component {
        ...
        return (
            <TouchableOpacity style={styles.agentMainContainer} onPress={this.itemPressed.bind(this, item)} activeOpacity={0.5}>
                <ProgressiveImage
                    ...
                    uri={item.photo_url ? item.photo_url : ''}
                ...
                <View style={styles.agentDetailContainer}>
                    <View style={styles.txtContainer}>
                        ...
                        <Text style={styles.txtCompanyName}>{item.company_name}</Text>
                    </View>
    ...
    itemPressed(item) {
        var params = {
            ...
            to: Utility.SCREEN.PropertyLawyerDetails,
            'lawyerDetails': item,
        };
        this.props.navigation.navigate(Utility.SCREEN.PropertyLawyerDetails, params)
    }
